...
use Sirius\View\Contracts\Engine;
...
use Sirius\View\Contracts\View as ViewContract;
...
class View implements ArrayAccess, ViewContract
{
     ...
     *
     * @var \Sirius\View\Contracts\Engine
     */
    protected $engine;
     ...
     *
     * @param  \Sirius\View\Factory  $factory
     * @param  \Sirius\View\Contracts\Engine  $engine
     * @param  string  $view
     * @param  string  $path
     * @param  mixed  $data
     * @return void
     ...
     *
     * @param  \Sirius\Support\Contracts\MessageProvider|array  $provider
     * @return $this
     */
     ...
     *
     * @return \Sirius\View\Contracts\Engine
     */
